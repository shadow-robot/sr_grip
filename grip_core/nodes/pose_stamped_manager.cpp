  ...
  : node_handler_(*nodehandler)
{
    ...
    reinitialise_service_ = node_handler_.advertiseService("reinitialise_pose_manager",
                                                           &PoseStampedManager::_reinitialise, this);
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool PoseStampedManager::_reinitialise(grip_core::ReinitManagerRequest& request,
